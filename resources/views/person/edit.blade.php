                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <select id="father_id" name="father_id"
                                                    ...
                                                    @foreach($fathers as $father)
                                                        <option @if($father->id === $person->father_id) selected @endif
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                <textarea id="bio" name="bio" rows="3"
                                                          ...
                                                          placeholder="Enter the bio of the Person">{{ $person->bio }}</textarea>
                                                <x-jet-input-error for="bio" />
                                            </div>
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="caste"
                                                       class="block text-sm font-medium text-gray-700">Caste</label>
                                                <input type="text" name="caste" id="caste" value='{{ $person->caste }}'
                                                       class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
